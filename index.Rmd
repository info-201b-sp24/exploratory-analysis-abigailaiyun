...
``````{r, echo = FALSE, fig.align='center', code = readLines("summary.R")}
``````
...
```
>>>>>>> db7ca1e14ff3afb0eef22af1b2c0e6439e3af0cc
<br>
<br>
...
because of the context of our first Chart, which is looking at the court surface 
